"""
Django settings for django_sso_server project.
...
SECRET_KEY = 'ptzz^ka79$q783##!q2e(_&4qk61w)8_krosss(e-*01+#vwr@'
...
ROOT_URLCONF = 'django_sso_server.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'sso.db'),
    }
}
